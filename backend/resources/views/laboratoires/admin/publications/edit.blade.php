...
<div class="container mt-4">
    ...
    <form action="{{ route('labo.publications.update', $publication->code_publi) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="mb-3">
            <label for="titre_publi" class="form-label">Titre <span class="text-danger">*</span></label>
            <input type="text" name="titre_publi" id="titre_publi" class="form-control @error('titre_publi') is-invalid @enderror" value="{{ old('titre_publi', $publication->titre_publi) }}" required maxlength="255">
            @error('titre_publi')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="domaine" id="domaine" class="form-control @error('domaine') is-invalid @enderror" value="{{ old('domaine', $publication->domaine) }}" maxlength="100">
            @error('domaine')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="resume" id="resume" class="form-control @error('resume') is-invalid @enderror" rows="4">{{ old('resume', $publication->resume) }}</textarea>
            @error('resume')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tags" id="tags" class="form-control @error('tags') is-invalid @enderror" value="{{ old('tags', $publication->tags) }}">
            @error('tags')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="reference" id="reference" class="form-control @error('reference') is-invalid @enderror" value="{{ old('reference', $publication->reference) }}">
            @error('reference')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="rapport_path" id="rapport_path" class="form-control @error('rapport_path') is-invalid @enderror" value="{{ old('rapport_path', $publication->rapport_path) }}">
            @error('rapport_path')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="id_pers_lab" id="id_pers_lab" class="form-select @error('id_pers_lab') is-invalid @enderror" required>
                ...
                @foreach($membres as $membre)
                    <option value="{{ $membre->id_pers_lab }}" {{ old('id_pers_lab', $publication->id_pers_lab) == $membre->id_pers_lab ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="code_lab" id="code_lab" class="form-control @error('code_lab') is-invalid @enderror" value="{{ old('code_lab', $publication->code_lab) }}">
            @error('code_lab')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
