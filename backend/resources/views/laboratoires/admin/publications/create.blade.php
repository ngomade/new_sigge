        ...
        <div class="card-body">
            ...
            <form action="{{ route('laboratoires.admin.publications.store', $laboratoire->code_lab) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="titre_publi" id="titre_publi" class="form-control @error('titre_publi') is-invalid @enderror" value="{{ old('titre_publi') }}" required maxlength="255" placeholder="Titre de la publication">
                            @error('titre_publi')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="code_projet" id="code_projet" class="form-select @error('code_projet') is-invalid @enderror">
                                ...
                                @foreach($projets as $projet)
                                    <option value="{{ $projet->code_projet }}" {{ old('code_projet') == $projet->code_projet ? 'selected' : '' }}>
                                        {{ $projet->theme_projet }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="domaine" id="domaine" class="form-control @error('domaine') is-invalid @enderror" value="{{ old('domaine') }}" maxlength="100" placeholder="Domaine scientifique">
                            @error('domaine')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="tags" id="tags" class="form-control @error('tags') is-invalid @enderror" value="{{ old('tags') }}" placeholder="Ex: biologie, chimie">
                            @error('tags')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="reference" id="reference" class="form-control @error('reference') is-invalid @enderror" value="{{ old('reference') }}" placeholder="Référence bibliographique">
                            @error('reference')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="resume" id="resume" class="form-control @error('resume') is-invalid @enderror" rows="3" placeholder="Résumé de la publication">{{ old('resume') }}</textarea>
                    @error('resume')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
