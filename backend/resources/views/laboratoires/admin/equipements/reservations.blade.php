                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form
                            ...
                            <div class="mb-3">
                                <label for="id_pers_lab" class="form-label">Membre <span
                                        class="text-danger">*</span></label>
                                <select class="form-select @error('id_pers_lab') is-invalid @enderror" id="id_pers_lab"
                                    name="id_pers_lab" required>
                                    <option value="">Sélectionner un membre</option>
                                    @foreach ($personnel as $pers)
                                        <option value="{{ $pers->id }}"
                                            {{ old('id_pers_lab') == $pers->id ? 'selected' : '' }}>
                                            @if ($pers->persLab)
                            ...
                            <div class="mb-3">
                                <label for="debut_reserv" class="form-label">Date de début <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="fin_reserv" class="form-label">Date de fin <span
                                        class="text-danger">*</span></label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($reservation->isActive())
                                                        <br><small
                                                            class="text-success">{{ $reservation->getJoursRestantsFormatted() }}</small>
                                                    @endif
                                                </td>
                                                <td>{{ $reservation->getDureeFormatted() }}</td>
                                                <td>
                                                    <div class="dropdown">
                                                        <a class="text-muted dropdown-toggle font-size-16 p-2"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @if ($reservation->isEnAttente())
                                                                <a class="dropdown-item text-success" href="#"
                                                                    onclick="changerStatutReservation('{{ $reservation->id }}', 'confirmé')">
                                                                    <i class="bx bx-check me-2"></i>Confirmer
                                                                </a>
                                                                <a class="dropdown-item text-danger" href="#"
                                                                    onclick="changerStatutReservation('{{ $reservation->id }}', 'refusé')">
                                                                    <i class="bx bx-x me-2"></i>Refuser
                                                                </a>
                                                            @endif
                                                            @if ($reservation->isConfirme() && !$reservation->isPasse())
                                                                <a class="dropdown-item text-warning" href="#"
                                                                    onclick="changerStatutReservation('{{ $reservation->id }}', 'annulé')">
    ...
    <script>
        function changerStatutReservation(reservationId, nouveauStatut) {
            ...
            if (confirm(message)) {
                ...
                document.getElementById('changerStatutReservationForm').action =
                    '{{ url("/laboratoires/{$laboratoire->code_lab}/admin/equipements/{$equipement->code_equip}/reservations") }}/' +
                    reservationId;
