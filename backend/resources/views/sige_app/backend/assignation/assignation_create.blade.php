...
@section('title', 'Créer une Assignation')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 mb-0">Créer une Assignation</h1>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Informations de l'assignation</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="code_pers" 
                                ...
                                @foreach($personnels as $personnel)
                                    <option value="{{ $personnel->code_pers }}" {{ old('code_pers') == $personnel->code_pers ? 'selected' : '' }}>
                                        {{ $personnel->nom_pers }}
                                    </option>
                                @endforeach
                            </select>
