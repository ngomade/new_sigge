        ...
        <div class="modal-content">
            ...
            <form action="/ajouter_division" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-11 m-auto">
                        <input type="text" class="form-control" placeholder="Code Division" name="code_division" id="code_division" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-sm-11 m-auto">
                        <input type="text" class="form-control" placeholder="Label de la division" name="label_div" id="label_div" required>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-11 m-auto">
                            <textarea class="tinymce-editor w-100" name="desc_div" id="desc_div" placeholder="Veuillez faire une breve description de la division ici" rows="8">
                            </textarea>
                        </div>
                    </div>
                </div>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="/delete_division/{{$division->code_division}}"  class="btn-outline-danger rounded p-1"><i class='bx bx-x-circle'></i> </a>
                        <a href="/update_division/{{$division->code_division}}"  class="btn-outline-success rounded p-1"><i class='bx bx-pencil'></i> </a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
