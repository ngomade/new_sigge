                    ...
                    <form action="/basculement_save" method="post">
                        ...
                        @if ($users->count() >=1)
                            ...
                            <div class="row mt-2">
                                <div class="col-4">
                                    <div class="row">
                                        <label for="niveau_c" class="col-sm-4 col-form-label">Niveau Cible<span class="text-danger">*</span></label>
                                        <div class="col-5">
                                ...
                                <div class="col-4">
                                    <div class="row">
                                        <label for="option_b" class="col-sm-6 col-form-label">Option de Basculement<span class="text-danger">*</span></label>
                                        <div class="col-6">
