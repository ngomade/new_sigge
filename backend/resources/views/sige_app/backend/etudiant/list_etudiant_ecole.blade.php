                ...
                @isset($users)
                    <div class="col-2">
                        <form action="/find_candidats_site" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <input type="text" placeholder="rechercher par nom, prenons ou tel" name="keyword" ,
            ...
            <div class="card-body">
                <form action="/changement_site_save" method="post">
                    ...
                    @isset($users)
                            ...
                            <table class="table table-bordered table-hover datatable" id="filterTable">
                                ...
                                @foreach ($users as $user)
                                    <tr style="text-transform: uppercase;">
                                        ...
                                        <td><input type="checkbox" name="selected_users[]" value="{{$user->code_user}}">
                                        </td>
                                        <td>{{ $user->nom_user }}</td>
                        ...
                        @else
                            <div class="alert alert-primary w-50 h4 m-auto"> Aucun étudiant ne correspond à vos critères
                                de recherche
                            </div>
                        @endif
                    @endisset
