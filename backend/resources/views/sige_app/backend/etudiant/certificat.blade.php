        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header row">
                    ...
                    <div class=" col-9">
                        <form action="/search_user/certificat" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-2">
                ...
                <div class="card-body">
                    <form action="/certificat" method="post">
                        @csrf
                    @isset($users)
                        @if ($users->count() >=1)
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr style="text-transform: uppercase;">
                                        ...
                                        <td><input type="checkbox" name="selected_users[]" checked value="{{ $user->code_user }}"></td>
                                        <td>{{ $user->nom_user }}</td>
                    ...
                    <div class="mt-4 text-center">
                        <button type="submit" class="btn btn-outline-danger">Imprimer &nbsp;<i class='bx bxs-file-pdf' ></i></button>
                    </div>
                    @else
