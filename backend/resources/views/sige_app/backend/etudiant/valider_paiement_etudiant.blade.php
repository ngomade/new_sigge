                ...
                <form action="/valider_paiement" method="post" style="justify-content: center;">
                    ...
                    <div class="row mt-2" style="justify-content: center; margin-bottom: 1%;">
                        ...
                        <div class="col-sm-2" style="text-align: center;">
                            <a href="/imprimer/pdf-{{$fil}}" class=" btn btn-outline-danger rounded p-2" title="Imprimer en pdf"  target="blank"><i class='bx bxs-file-pdf' ></i></a> &nbsp; &nbsp; <a href="/imprimer/excel-{{$fil}}" class=" btn btn-outline-primary rounded p-2" title="Imprimer en Excel" target="blank"><i class="ri-file-word-2-line"></i></a>
                        </div>
                    </div>
                </form>
                <hr>
                ...
                <tr>
                    ...
                    ?>
                     <td style="text-align: center;">
                        <a href="#" onclick="showDeleteCandidatModal('{{$u->code_user}}-{{$fil}}')" class="btn-outline-danger rounded p-1"><i class='bx bx-x-circle'></i> </a>
                        <a href="/update_info/{{$u->code_user}}-{{$fil}}"  class="btn-outline-success rounded p-1"><i class='bx bx-pencil'></i> </a>
                    </td>
                    <td> {{$loop->index+1}}  </td>
                    <td> {{$u->code_user}}  </td>
                    <td> {{$u->nom_user}} </td>
