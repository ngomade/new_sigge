    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('ressources.salles.update', $salle->code_salle) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code_salle') is-invalid @enderror" 
                                           id="code_salle" name="code_salle" value="{{ old('code_salle', $salle->code_salle) }}" required>
                                    @error('code_salle')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('nb_place_salle') is-invalid @enderror" 
                                           id="nb_place_salle" name="nb_place_salle" value="{{ old('nb_place_salle', $salle->nb_place_salle) }}" 
                                           min="1" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('etat_salle') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('etat_salle', $salle->etat_salle) == '1' ? 'selected' : '' }}>Disponible</option>
                                        <option value="0" {{ old('etat_salle', $salle->etat_salle) == '0' ? 'selected' : '' }}>Indisponible</option>
                                    </select>
                                    @error('etat_salle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('desc_salle') is-invalid @enderror" 
                                              ...
                                              rows="3">{{ old('desc_salle', $salle->desc_salle) }}</textarea>
                                    @error('desc_salle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
