    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('ressources.documents.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('label_doc') is-invalid @enderror" 
                                           id="label_doc" name="label_doc" value="{{ old('label_doc') }}" required>
                                    @error('label_doc')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('type_doc') is-invalid @enderror" 
                                           id="type_doc" name="type_doc" value="{{ old('type_doc') }}" required>
                                    @error('type_doc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <select class="form-control @error('code_session') is-invalid @enderror" 
                                        ...
                                        @foreach($sessions as $session)
                                            <option value="{{ $session->code_session }}" 
                                                {{ old('code_session') == $session->code_session ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control @error('code_bureau') is-invalid @enderror" 
                                        ...
                                        @foreach($bureaux as $bureau)
                                            <option value="{{ $bureau->code_bureau }}" 
                                                {{ old('code_bureau') == $bureau->code_bureau ? 'selected' : '' }}>
                                                {{ $bureau->code_bureau }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description_doc') is-invalid @enderror" 
                                              ...
                                              rows="3">{{ old('description_doc') }}</textarea>
