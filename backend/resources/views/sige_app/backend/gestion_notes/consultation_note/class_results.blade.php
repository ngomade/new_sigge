    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 mb-0">Résultats de Classe</h1>
            </div>
...
<script>
    // Function to load class results
    function loadClassResults(classId, semesterId, yearId) {
        // This would make an AJAX call to getResultatsClasse method
        // and populate the class information and results
        document.getElementById('classInfo').textContent = 'Licence 1 - Génie Informatique';
        document.getElementById('classCode').textContent = classId;
        ...
        document.getElementById('classAverage').textContent = '12.8';
        
        document.getElementById('classResultsContent').innerHTML = `
