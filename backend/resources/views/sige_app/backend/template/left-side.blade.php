<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Components -->
      <li class="menu-header small text-uppercase"><span class="menu-header-text">Gestions des Actualités</span></li>
      <!-- Cards -->
      <li class="menu-item">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="#" class="menu-link"><div data-i18n="Ecole">Ecole</div></a>
              </li>
              <li class="menu-item">
          ...
          <li class="menu-item">
            <a href="/bureau/Departement" class="menu-link"><div data-i18n="Departement">Département</div></a>
          </li>
          <li class="menu-item">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="/gestion_role_perm" class="menu-link"><div data-i18n="roles">Rôles &amp; Permissions </div></a>
          </li>
          <li class="menu-item">
            <a href="/assignation_index" class="menu-link"><div data-i18n="assignations">Assignations</div></a>
          </li>
        </ul>
      </li>
      @endif
