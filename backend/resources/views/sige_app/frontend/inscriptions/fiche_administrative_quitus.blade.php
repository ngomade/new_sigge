            ...
            <hr>
                <div class="row">
                    ...
                    <div class="col-sm-2 bloc-telecharger">
                        ...
                        <a href="/telecharger_quitus/{{$nb_q1."_".$user->code_user."_".$code_filiere}}" target="blank"> Télécharger<i class="ri-arrow-down-circle-fill"></i></a>
                    </div>
                    <div class="col-sm-2 bloc-telecharger">
                        <p>Quitus Seconde Tranche</p>
                        <a href="/telecharger_quitus/{{$nb_q2."_".$user->code_user."_".$code_filiere}}" target="blank"> Télécharger<i class="ri-arrow-down-circle-fill"></i></a>
                    </div>
                    <?php $statut = \App\Models\Inscription::find($code_ins)->statut_ins ?>
                    @if($statut == 1)
                    {{-- <div class="row"> --}}
                        <div class="col-sm-2 bloc-telecharger m-auto">
                            <p style="text-align: center;">Fiche d'Inscription académique</p>
                            <a href="/academique_download/{{$code_ins}}" target="blank"> Télécharger <i class="ri-arrow-down-circle-fill"></i></a>
                        </div>
                    {{-- </div> --}}
                    @endif
                    <div class="col-sm-2 bloc-telecharger">
                        <p>Quitus Frais Médicaux</p>
                        <a href="/telecharger_quitus/{{$nb_q3."_".$user->code_user."_".$code_filiere}}" target="blank"> Télécharger <i class="ri-arrow-down-circle-fill"></i></a>
                    </div>
                </div>
            <hr>
            <div class="alert alert-success">
