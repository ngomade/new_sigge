...
@section('content')
    <div class="card w-5 m-auto mt-4" id="main-content">
        ...
        <div class="card-body" style="justify-content: center; border:1px solid rgb(194, 193, 193); box-shadow:1px 2px 2px rgb(175, 207, 224); height: 100%;">
            <div class="row m-auto" style="height: 100%;">
                <div class="col-sm-2">
                    <img src='{{asset("storage".DIRECTORY_SEPARATOR."app".DIRECTORY_SEPARATOR."public".DIRECTORY_SEPARATOR."departements".DIRECTORY_SEPARATOR.$bureau->code_bureau.DIRECTORY_SEPARATOR.$presentation->photo_chef)}}' alt="Photo du chef de département" title="Photo du chef de département" style="width:100%; height:85%;">
            ...
            <div class="row m-auto p-1 bordered">
                ...
                <div class="col-sm-4 m-auto justify-content-center" style="text-align: justify;">
                    <div id="carouselExample" class="carousel slide justify-content-center" style="width:100%; margin: auto;">
                    ...
                    <div style="text-align: center;" class="mt-2">
                        <a href="/download_grille/{{$bureau->code_bureau}}/depliant_ingenieur" class="btn btn-outline-success"> Télécharger</a>
                    </div>
                </div>
            </div>
            <div class="bordered">
