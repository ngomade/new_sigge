    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class=" h4" style="text-align: center; color: red; line-height: 35px;">LES ÉPREUVES ÉCRITES DU
                    CONCOURS D'ENTREE À L'ESTLC INITIALEMENT PREVUES LE 26 SEPTEMBRE 2024 SONT REPORTÉES AU JEUDI, 17
                    OCTOBRE 2024.
                ...
                <div style="display: flex; justify-content: center;" class="mt-4">
                    <a class="btn btn-outline-success blink" target="blank"
                       href="https://inscription-univ-ebolowa.vercel.app">Inscription</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>Nos Départements</span> <i
                    ...
                    <ul>
                        @foreach (\App\Models\Bureau::where("type_bureau", "Departement")->get() as $bureau)
                            <li>
                                <a href="/presentation_departement/{{$bureau->code_bureau}}"> {{$bureau->label_bureau}} </a>
                            </li>
                        @endforeach
                ...
                <li class="dropdown"><a href="#"><span>Espace étudiants</span> <i
                    ...
                    <ul>
                        ...
                        @if (Session::has("user"))
                            <li><a href="/retelecharger_fiche/{{\Session::get("user")->code_user}}" target="blank">Mes
                                    Fiches et Quitus</a></li>
                ...
                <li class="dropdown"><a href="#"><span>Emploi de Temps</span> <i
                    ...
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Niveau 1</span> <i
                            ...
                            <ul>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=9b0aa6f6117fd0833e73c3faf605624a9e9162e35d6a52a3a88f1c5bf6cc7a1f%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">GLTCO</a></li>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=e39494864ee8a8eedfd81a50f538a6690c92384837b8056afc15552a0c817244%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">TTL</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#"><span>Niveau 2</span> <i
                            ...
                            <ul>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=83faabc5941900a4dae8d5ee93906cf3ad763e2e53d6882df7f248bb9e34489d%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">GLTCO</a></li>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=4b2bd45d36efd8ea7c52f04d0a2940b6fe79c68021e692e6aff979d93258985d%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">TTL</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#"><span>ISLAPE</span> <i
                            ...
                            <ul>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=99f9a29f1c8eedca770b1be252067a0090c8e5bc4918f2a2688ae1fe90365290%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">GLTCO 1</a></li>
                                <li>
                                    <a href="https://calendar.google.com/calendar/embed?src=e2e18a2eb9b57eb143093703a9160b58d39ebb0e33178802fd2ed670b86c519f%40group.calendar.google.com&ctz=Africa%2FLagos"
                                       target="blank">TTL 1</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="https://calendar.google.com/calendar/embed?src=24441c7f4123f4e4329dc47884ac56b92aa540d31f647897a5dd429551ec0f45%40group.calendar.google.com&ctz=Africa%2FLagos"
                               target="blank">Permanence</a></li>
                    </ul>
                </li>
                <li><a href="https://web44.lws-hosting.com:2096/cpsess3484228458/3rdparty/roundcube/index.php"
                       class="nav-link scrollto" target="blank">Ma Messagerie</a></li>
                ...
                @else
                    <li><a class="getstarted scrollto bg-success" data-bs-toggle="modal"
                           data-bs-target="#connexionModal" href="">Connexion</a></li>
                @endif
            </ul>
