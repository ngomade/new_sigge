    ...
    <div class="row g-0 p-0">
      <div class="col-md-12 p-0">
        <div class="card-header bg-success row p-1 m-0" style="color: white">
            <h5 class="card-title col-sm-11 m-0 p-0">Mon Compte</h5>
            <h3 class="col-sm-1 m-0 p-0"><i class="ri-user-3-fill"></i></h3>
        </div>
        <div class="card-body p-3 mt-1 row">
            <?php $res = Session::get("user");?>
            <div class="col-sm-9" style="border-right: 1px double rgb(223, 223, 223)">
                <p class="card-text mb-1 text-success" style="font-size: 1.11em;">Chèr(e) <b>{{$res->ca_prenom}} {{$res->ca_nom}}</b>, Vous êtes dans votre compte personnel.</p>
                <hr>
            ...
            <div class="col-sm-3">
                    ...
                    <a href="/logout" class=""><button class="getstarted scrollto btn btn-outline-danger m-5 mt-3 mb-1">Déconnexion</button></a>
            </div>
        </div>
      </div>
    </div>
