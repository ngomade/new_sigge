...
<body>
    <div style="width: 80%; margin:auto;">
        ...
        <hr>
        <div class="card-body">
            <p class="text-danger" style="font-size: 1.4em; text-align: center; font-family: Arial Narrow;">Code et mot de passe à usage unique et à ne divulguer à personne!!!</p>
