...
class SendinfoOfConnection extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->view('concours.info_connexion_mail', [
                'compte' => $notifiable,
            ]);
    }
    ...
    {
        return [
            'user_type' => $notifiable instanceof Compte ? 'candidat' : 'admin',
            'user' => $notifiable,
            'message' => 'Vos informations de connexion ont été envoyées par email.',
        ];
    }
}
