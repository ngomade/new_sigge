...
// Routes avec authentification (à activer plus tard)
/*
Route::middleware('auth:sanctum')->prefix('concours')->group(function () {
    // Placer ici les routes qui nécessitent une authentification
});
*/