...
Route::match(['put', 'post'], '/laboratoires/{code_lab}/admin/projets/{projet}', [\App\Http\Controllers\Labo\AdminLaboratoireController::class, 'projetUpdate'])->name('laboratoires.admin.projets.update');
