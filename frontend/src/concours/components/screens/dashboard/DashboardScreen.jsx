        ...
        <tbody>
        {
            data.filiere.map((fil, k) => (
              ...
              <tr key={k} className="bg-white border dark:bg-gray-800 dark:border-gray-700 text-xs">
                ...
                <td className="px-3 py-3 border border-slate-300">{data.candidats.filter(candidat=>candidat.filiere_code === fil["code_filiere"] && candidat.ca_sexe ==="Feminin").length}</td>
