            ...
            <form action="" method="post" id='form_concours' onSubmit={onSubmit}>
                <div className="grid items-center grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className='flex flex-col gap-3 mb-3'>
                        ...
                        <select id='centre_depot' value={formData.centre_depot} name="ca_centre_depot" placeholder='Exp: Lycée Bilingue d Ambam' className='p-2 border border-teal-600 rounded-md outline-none focus:outline-teal-600/15 indent-1' onChange={onChange} >
                        <option value="">Selectionner un centre</option>
                    ...
                    <div className='flex flex-col gap-3 mb-3'>
                        ...
                        <select id='site_formation' name="code_site" value={formData.code_site}  className='p-2 border border-teal-600 rounded-md outline-none focus:outline-teal-600/15 indent-1' onChange={function(e){
                            onChange(e)
                            setTimeout(() => {
                ...
                <div className='grid bg-white font-bold text-lg grid-cols-1 h-15 place-items-center mb-2 rounded   m-auto shadow-lg shadow-green-800 rounded p-6 '>
                    <div className='mb-5  text-justify p-3 text-l text-gray-800 leading-10' dangerouslySetInnerHTML={{__html:siteCompoDescription.description_site}}/>
                </div>
                )}
