        ...
        <div className='flex items-center py-12 justify-center flex-col'>
                ...
                candidat !== 'null' ? (
                    ...
                    (
                        <div className="text-center mb-3 p-5 text-xl font-bold rounded-lg bg-amber-400/50">
                            Félicitations !!! Votre compte a été crée avec success. Cliquez sur le bouton ci-dessous pour complèter votre candidature.
                        </div>
                    )
            }
            <hr />
            ...
            <div className='mb-3'>
                ...
                <ol className=' list-decimal leading-10'>
                    <li>
                        Bien vouloir imprimer imprimer la fiche d'inscription en couleur sous peine d'un rejet de candidature;
                    </li>
                    <li>
                    ...
                    <li>
                        En cas de perte de cette fiche bien vouloir vous connecter sur cette plateforme avec vos identifiants;
                    </li>
                </ol>
            </div>
           {
           candidat !== 'null' ?(
                ...
                <Link to="/candidate" className='p-3 bg-amber-600 text-white rounded-md flex items-center gap-2'><LuUserCheck size={20} /> Complèter votre candidature</Link>
            )
           }
        </div>
    )
